var snowStorm = (function(window, document) {
  ...
  this.flakesMax = 125;           // Limit total amount of snow made (falling + sticking)
  this.flakesMaxActive = 160;      // Limit amount of snow falling at once (less = lower CPU use)
  ...
  this.SnowFlake = function(parent,type,x,y) {
    ...
    this.o = document.createElement('i');
	this.o.className = "icon-star-empty";
